namespace Universal_x86_Tuning_Utility.Models
{
    ...
    /// Each command is wrapped in a fixed 7-byte frame: FE [cmd] [enable] [paramA] [paramB] [paramC] EF
    /// No checksum — the device parses fixed byte offsets within the frame.
    /// </summary>
